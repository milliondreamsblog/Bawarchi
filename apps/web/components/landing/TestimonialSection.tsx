            ...
            <div className="container max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-[var(--text-muted)] max-w-2xl mx-auto">
                        Built for Indian restaurants — onboarding our founding cohort
                    </p>
                </div>
                ...
                <div className="mt-16 p-8 bg-gradient-to-r from-green-500/10 to-emerald-500/5 border border-green-500/20 rounded-3xl">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {[
                            { value: "Live", label: "Onboarding Now" },
                            { value: "40%", label: "Avg. Table Turnover Lift" },
                            { value: "100%", label: "Order Accuracy" },
                            { value: "24–48h", label: "Average Setup" }
                        ].map((stat, index) => (
